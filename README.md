...
Go to the **https://github.com/zxz0119/DJI-RC-N1-Simulator-GUI/releases/tag/v2.0** page to download the simulator:
前往右侧 **https://github.com/zxz0119/DJI-RC-N1-Simulator-GUI/releases/tag/v2.0** 页面下载模拟器主程序：
